            ...
            when(response){
                is Resource.Success ->{
                    ...
                    response.data?.let {newsResponse ->
                        newsAdapter.differ.submitList(newsResponse.articles.toList()) //mutable ekis, normal list works on differ
                        val totalPages = newsResponse.totalResults / QUERY_PAGE_SIZE + 2 //WE HAVE INTEGER DIVISON and we have to round off and last is always empty
